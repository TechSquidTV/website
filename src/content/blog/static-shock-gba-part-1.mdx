...
If you take a closer look at the name of the channel this was uploaded to "PVCF's DevKid for Cryengine 1.4", that is a bit of a long name, but we saw earlier in a comment that this channel was possibly owned by the musical artist for the came. If we search Kai Walter we can find [his SounCloud!](https://soundcloud.com/user-175015091) Where we can confirm, his artist name is PVCF!
