...
description: In 2004 Static Shock was set to get his own video game for Gameboy Advance, but it was cancelled two months before release. What happened to it? The 20-year search begins!
...
We do not know who skyvolt is, yet, or how they obtained this YouTube link, but this appears to be the first and only time this video has been shared publicly, that Google is aware of at this time. Being unlisted, the only way to find this video, is with the link, it is not searchable. At the time of writing this post, this video has 225 views, and user skyvolt, claims this was posted by a developer of the game.
...
And unfortunately, a few people have reported emailing this address and not receiving a response. But, we did bet two fairly significant clues from this comment. However, I feel like documenting my next steps would begin to invade on personal privacy, so I will leave it the details at that. 
