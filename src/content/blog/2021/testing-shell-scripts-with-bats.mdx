...
tags:
  - coding
  - linux
commentThreadId: "20db845e-4b2a-47f8-ae07-7e983a73d6d5"
discussionId: "D_kwDOKvG2_s4Ao10D"
---
...
Now that you've had a micro-crash-course on writing Bash functions, let's take a look at testing our new Bash script using the [BATS-Core Bash Automation Testing System](https://github.com/bats-core/bats-core#run-test-other-commands).
