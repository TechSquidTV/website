...
oldPermalink: "https://techsquidtv.com/blog/Making_your_own_home_media_server_with_plex_and_Docker-Compose"
path: making-a-home-media-server-with-plex-and-docker-compose
tags:
  - linux
---
...
<Image src={Emby} alt="emby screenshot" />
...
<Image src={JellyFin} alt="jellyfin screenshot" />
...
<Image src={DFUtil} alt="df screenshot" />
