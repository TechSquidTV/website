...
tags:
  - coding
commentThreadId: "7ff4cbbd-8bca-49dd-95d1-db55a2ea3f5a"
discussionId: "D_kwDOKvG2_s4Ao10L"
---
...
<div class="flex h-full w-full flex-col">
  <a
    href={video["media:group"]["media:content"]["@_url"]}
    target="_blank"
    class="relative flex-1"
  >
    <div class="absolute top-1/2 right-1/2 m-2 translate-x-1/2 -translate-y-1/2 transform">
      <Icon name="playCircle" size={24} />
    </div>
    <Image
      class="border-border h-full w-full rounded-md border object-cover object-center sm:h-48 md:h-52 xl:h-64"
  ...
  <div class="mx-8 flex flex-1 flex-col justify-between py-2">
    <h2 class="text-smoke-50 mb-2 text-4xl font-bold break-words">
      {video["media:group"]["media:title"]}
    </h2>
    <div class="my-1 text-sm">
      <a
        class="ring-smoke-800 text-smoke-300 inline-flex flex-row items-center rounded-full px-2 ring-1"
        target="_blank"
        href={video["media:group"]["media:content"]["@_url"]}
      >
        watch
...
_Demo component would appear here showing the latest FreeCodeCamp video_
