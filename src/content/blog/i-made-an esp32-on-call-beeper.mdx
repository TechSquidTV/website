...
<span class="flex flex-row border-border items-center gap-2 px-2 py-1 mb-[2em] border-2 rounded-sm">
  <Icon name="file-3d" size={20} />
  <span> <a href="https://github.com/KyleTryon/sentry-alert-tx-1/tree/main/STLs">STL files</a> are available on GitHub.</span>
</span>
