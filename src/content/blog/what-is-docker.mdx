...
heroImage: ../../images/blog/docker-in-5-thumbnail.webp
heroImageAlt: "The video thumbnail for TechSquidTV's 'Docker in 5 minutes" video."
...
<Image src={DockerContainerShip} alt="A shipping container with the Docker logo on it" />
