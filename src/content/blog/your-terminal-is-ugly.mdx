...
oldPermalink: "https://techsquidtv.com/blog/Fixing_an_ugly_terminal"
path: your-terminal-is-ugly
tags:
  - linux
---
...
### <a name="WindowsTerminal"></a>Windows Terminal
...
<Image src={PowerLevel10k} alt="A themed terminal showing the multiple styles offered by PowerLevel10K" />
...
<Image src={NeoVIMNightFox} alt="Neovim with customizations that make it look like a full IDE" />
