...
slug: will-we-ever-be-able-to-download-our-brains-like-in-westworld
tags:
  - technology
commentThreadId: "dcb731fe-3838-4679-9cb2-88f5c2e6c812"
discussionId: "D_kwDOKvG2_s4Ao1z9"
---

import { Image } from "astro:assets";
import WestworldNaturalLanguage from "@/images/blog/westworld-natural-language.gif";
import Captcha from "@/images/blog/captcha.jpg";
...
In “The Riddle of the Sphinx” (Season 2, Episode 4) our two heroes for this scene, Elsie and Bernard are exploring a secret bunker somewhere deep in the park when they discover a hidden underground testing lab. In it, they find James Delos.
...
<Image src={Captcha} alt="Google's reCaptcha" />
...
<Image
  src={WestworldNaturalLanguage}
  alt="A depiction from Westworld showing a natural language processor-like UI showing sentences being constructed from multiple possible word choices."
/>
...
<div class="giphy-embed">
  <video class="w-full" autoplay="" loop="" muted="" playsinline="">
    <source
      src="https://media.giphy.com/media/8FSLJbbl50RIa0AazA/giphy.mp4"
      type="video/mp4"
    />
    <img
      src="https://media4.giphy.com/media/8FSLJbbl50RIa0AazA/giphy.gif"
      title="Your browser does not support the mp4 video codec."
      alt="Your browser does not support the mp4 video codec."
    />
  </video>
  <small>
    Via{" "}
    <a
      href="https://media.giphy.com/media/8FSLJbbl50RIa0AazA/giphy.gif"
      target="_blank"
