...
<Image src={TSTVWordpressSite} alt="A screenshot of the old TechSquidTV website, which was built using WordPress." />
...
<Image src={NuxtPerformanceVWordpress} alt="wordpress vs nuxt speed comparison" />
